...
#define selectNodesV7(configs) \
SelectNodesV7<WARPSIZE> <<<gdim, bdim, sharedLimit>>> \
(devInt2Distances,devF1, devF2, devF3, devSizes, distanceLimit, sharedLimit,level);

#define kernelV7Atmoic64(vwSize,gridDim, blockDim,sharedLimit,stream, devPF, devPFSize) \
HBFSearchV7Atomic64<vwSize><<<gridDim, blockDim, sharedLimit ,stream>>> \
(devUpOutNodes, devUpOutEdges, devInt2Distances, devPF, devPFSize, devF2, devSizes, sharedLimit,level);