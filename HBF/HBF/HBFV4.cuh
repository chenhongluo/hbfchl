...
#define selectNodesV4(configs) \
SelectNodesV4<WARPSIZE> <<<gdim, bdim, sharedLimit>>> \
(devInt2Distances,devF1, devF2, devF3, devSizes, distanceLimit, sharedLimit,level);

#define kernelV4Atmoic64(vwSize,gridDim, blockDim,sharedLimit) \
...
#define switchKernelV4(atomic64,vwSize,gridDim, blockDim,  sharedLimit ) \
{\
	if (atomic64) {  \
		switch (vwSize) { \
		case 1:\
			kernelV4Atmoic64(1,gridDim, blockDim, sharedLimit);break; \
		case 2: \
			kernelV4Atmoic64(2,gridDim, blockDim, sharedLimit); break;\
		case 4: \
			kernelV4Atmoic64(4,gridDim, blockDim, sharedLimit); break;\
		case 8: \
			kernelV4Atmoic64(8,gridDim, blockDim, sharedLimit); break;\
		case 16: \
			kernelV4Atmoic64(16,gridDim, blockDim, sharedLimit); break;\
		case 32: \
			kernelV4Atmoic64(32,gridDim, blockDim, sharedLimit); break;\
		case 64: \
			kernelV4Atmoic64(64,gridDim, blockDim, sharedLimit); break;\
		case 128: \
			kernelV4Atmoic64(128,gridDim, blockDim, sharedLimit); break;\
		default: \
...
#define switchKernelV4Config(configs) \
	switchKernelV4(configs.atomic64,vwSize,gdim, bdim,sharedLimit)